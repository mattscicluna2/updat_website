    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'btn_label', [
                ...
                'default' => 'Subscribe',
                'condition' => [
                    'style' => ['style_01', 'style_03', 'style_04', 'style_05', 'style_06', 'style_07', 'style_08', 'style_10']
                ]
            ]
        );
        ...
        $this->add_control(
            'subscribe_form_input_focus', [
                'label' => __( 'Input Field Focus Border Color', 'saasland-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .subcribes .form-control:focus' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            'color_subtitle', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .payment_subscribe_info .payment_subscribe_content p' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '
                    ...
                    {{WRAPPER}} .payment_subscribe_info .payment_subscribe_content p
                    ',
            ]
        );
