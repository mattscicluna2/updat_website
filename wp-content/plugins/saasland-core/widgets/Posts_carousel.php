...
class Posts_carousel extends Widget_Base {
    ...
    protected function render() {
        ...
        if ( !empty($settings['post_type'] == 'post') ) {
            $posts = new WP_Query(array(
                'post_type' => $settings['post_type'],
                'posts_per_page'=> $settings['show_count'],
                'order' => $settings['order'],
                'category_name' => !empty( $settings['category_name'] ) ? $settings['category_name'] : '',
            ));
        }
        else {
            ...
            if( !empty( $settings['category_name'] ) ){
                $args['tax_query'] = array(
                    array(
                        'taxonomy' => $settings['post_type'].'_cat',
                        'field'    => 'slug',
                        'terms'    =>  !empty( $settings['category_name'] ) ? $settings['category_name'] : '',
                    ),
                );
            }
