! function(e, t, i) {
    ...
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, templateEditor.i18n)
    };
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        template: "#saasland-liteTemplateLibrary_empty",
        ui: {
        ...
        template: "#saasland-liteTemplateLibrary_loading",
        id: "liteTemplateLibrary_loading"
    }), a.Views.Logo = Marionette.ItemView.extend({
        template: "#saasland-liteTemplateLibrary_header-logo",
        ...
        template: "#saasland-liteTemplateLibrary_header-back",
        ...
        template: "#saasland-liteTemplateLibrary_header-menu",
        ...
        template: "#saasland-liteTemplateLibrary_header-menu-responsive",
        ...
        template: "#saasland-liteTemplateLibrary_header-actions",
        ...
        template: "#saasland-liteTemplateLibrary_header-insert",
        ...
        template: "#saasland-liteTemplateLibrary_preview",
        ...
        template: "#saasland-liteTemplateLibrary_templates",
        ...
        template: "#saasland-liteTemplateLibrary_template",
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !templateEditor.hasPro ? "pro-button" : "insert-button";
            return viewId = "#saasland-liteTemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
        ...
        function i() {
            ...
            n && _.each(n, function(e, t) {
                a === e.id && (p.atIndex = t)
            }), r.find(".elementor-add-lite-button").length || r.find(FIND_SELECTOR).before($openLibraryButton)
        }

        function n(e) {
            var t = e.find(FIND_SELECTOR);
            t.length && !e.find(".elementor-add-lite-button").length && t.before($openLibraryButton), e.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", i)
        }
        ...
        function r(t, i) {
            ...
            e(".liteTemplateLibrary_preview").css("width", a)
        }
        ...
        function l() {
            ...
            e.on("click.onAddTemplateButton", ".elementor-add-lite-button", p.showModal.bind(p)), this.channels.tabs.on("change:device", r)
        }
        var o, s, d, c, m, p = this;
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-lite-button"> <img src="'+templateEditor.templateLogo+'" /> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_lite_template_data", i)
    ...
    }, i.library = new a.Manager, i.library.init(), window.lite = i
}(jQuery, window.elementor, window.lite || {});