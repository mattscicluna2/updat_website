...
class DL_Templates
{
    ...
    public function init()
    {
        ...
        add_action( 'elementor/editor/after_enqueue_scripts', function() {     
            wp_enqueue_style( "droit-el-template-editor", self::url() . 'assets/css/template-library.min.css' , ['elementor-editor'], self::version() );  
            wp_enqueue_script("droit-el-template-editor", self::url() . 'assets/js/template-library.min.js', ['elementor-editor'], self::version(), true); 
