...
Redux::setSection( 'saasland_opt', array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'text-align'    => false,
            'color'         => false,
            'output'        => array( '.ctn-preloader .animation-preloader .txt-loading, .ctn-preloader .animation-preloader .txt-loading .letters-loading:before' ),
            'required'      => array( 'preloader_style', '=', 'text' ),
        ),
